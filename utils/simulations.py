...
class Simulation(Operators):
    def __init__(self, number_of_ions = 1,
        ...
        self.Hamiltonian = Hamiltonian(self.umber_of_ions,
                self.dim_of_electronic_states_space,
                self.number_of_motional_modes,
                self.dim_of_each_Fock_space)

    def add_hamiltonian(self, hamiltonian: types.Hamiltonian):
        self.Hamiltonian()
